$.Redactor.prototype.table = function() {
    return {
        ...
        init: function() {
            ...
            // console.log(typeof this.opts.properties === 'undefined')
            ...
            if (typeof this.opts.tableClassNames != 'undefined') {
                ...
                dropdown.clear_styles = {
                    ...
                    func: this.table.clearTableComponent,
                    observe: {
                        element: 'table',
                        out: {
                            attr: {
        ...
        setTableComponent: function(className) {
            var $table = this.table.getTable();
            if (!$table) {
                return;
            }
            this.table.clearTableComponent();
            $table.addClass(className);
        },
        clearTableComponent: function() {
            var $table = this.table.getTable();
            if (!$table) {
                return;
            }
