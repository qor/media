    ...
    $R.add("plugin", "table", {
            ...
            if (
              ...
              var optionsHtml = tableClassNames.reduce(function(memo, data) {
                ...
                if (classArr && classArr.length === 2) {
                  ...
                  return (
                    memo +
                    `<option value="${classValue}">${classTitle}</option>`
                  );
                }
              }, "");
      ...
      start: function() {
        ...
        $("body").on("click", function(e) {
          ...
          var isInDropDown =
            $(e.target).closest(".redactor-dropdown").length > 0;
      ...
      renderColGroup: function($table, changeColIndex, changeColWidth) {
        ...
        var minColWidthPercent = (_this.minCellWidth /
          tableWidth *
          100).toFixed(2);
        ...
        if (
          ...
          var nextWidth =
            nextCol.attr("width").split("%")[0] / 100 * tableWidth;
          var nextChangeWidth =
          ...
          if (currentChangeWidth < minColWidth) {
            ...
            changeColWidth =
              minColWidth - currentWidth * minColSpansLeft.colSpan;
          }
          ...
          var colgroupCol = _this.tableBodyElements[0].reduce(function(
            ...
            if (changeColIndex != undefined) {
              if (
                changeColIndex - minColSpansLeft.colSpan + 1 <=
                  tableElementIndex &&
          ...
          $tableTHTB.find("tr").each(function(indexTr) {
            ...
            $findTdThs.each(function() {
              ...
              function getInserCell(indexTr, tdIndex) {
                ...
                var currentRowSpanLength =
                  $(currentElement).attr("rowspan") || 1;
                var currentColSpanLength =
                  $(currentElement).attr("colspan") || 1;
      ...
      addRowBelow: function() {
        ...
        if (table) {
          ...
          var targetTdTh = _tableElements[
            currentTd.lastPoint.row
                  ...
                  if (rowspan > 1) {
                    ...
                    if (cell.firstPoint.row == currentRow) {
                      ...
                      if (i - 1 < 0) {
                        ...
                        $(cell).insertAfter(
                          _tableElements[currentRow + 1][i - 1]
                        );
                      }
                    }
                  }
